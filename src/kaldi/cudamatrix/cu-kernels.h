...
inline void cuda_diff_square_relu(dim3 Gr, dim3 Bl, float* mat, MatrixDim dim) { cudaF_diff_square_relu(Gr,Bl,mat,dim); }
...
inline void cuda_square_relu(dim3 Gr, dim3 Bl, float* mat, float floor_val, MatrixDim dim) { cudaF_square_relu(Gr,Bl,mat,floor_val,dim); }
...
//<<<<<<< HEAD
inline void cuda_parametric_relu(dim3 Gr, dim3 Bl, float *y, const float *x, MatrixDim d, int src_stride, const float *a, const float *b) { cudaF_parametric_relu(Gr,Bl,y,x,d,src_stride,a,b); }
inline void cuda_diff_parametric_relu(dim3 Gr, dim3 Bl, float *eout, const float *e, const float *y, MatrixDim d, int e_stride, int y_stride, const float *a, const float *b) { cudaF_diff_parametric_relu(Gr,Bl,eout,e,y,d,e_stride,y_stride,a,b); }
...
inline void cuda_diff_square_relu(dim3 Gr, dim3 Bl, double* mat, MatrixDim dim) { cudaD_diff_square_relu(Gr,Bl,mat,dim); }
...
inline void cuda_square_relu(dim3 Gr, dim3 Bl, double* mat, double floor_val, MatrixDim dim) { cudaD_square_relu(Gr,Bl,mat,floor_val,dim); }
...
//<<<<<<< HEAD
inline void cuda_parametric_relu(dim3 Gr, dim3 Bl, double *y, const double *x, MatrixDim d, int src_stride, const double *a, const double *b) { cudaD_parametric_relu(Gr,Bl,y,x,d,src_stride,a,b); }
inline void cuda_diff_parametric_relu(dim3 Gr, dim3 Bl, double *eout, const double *e, const double *y, MatrixDim d, int e_stride, int y_stride, const double *a, const double *b) { cudaD_diff_parametric_relu(Gr,Bl,eout,e,y,d,e_stride,y_stride,a,b); }
