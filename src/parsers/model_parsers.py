...
import sys
sys.path.append('/mnt/matylda6/baskar/experiments/Tensorflow/sandbox/ModelSelectionVAE/src/parsers')
...
class cvae_model_parser(fvae_model_parser):
    def __init__(self, model_config_path):
        ...
        self.config["conv_enc"] = str('64_1_200_1_1_valid,128_3_1_2_1_same,256_3_1')
